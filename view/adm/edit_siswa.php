<?php 
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="number" value="<?php echo $nis_user; ?>" class="form-control" name="nis" placeholder="Masukan NIK" required>
    </div>
  </div>
  ...
  <div class="form-group">
    <label class="control-label col-sm-2" for="sekolah">Jabatan:</label>
    <div class="col-sm-10">
      <input type="text" value="<?php echo $sklh_user; ?>" class="form-control" name="sklh" placeholder="Masukkan Kelas" required>
    </div>
  </div>
  <div class="form-group">
  ...
  <fieldset>
    ...
    <div class="col-sm-10"> 
    <a href="katasandi&id=<?php echo $id_user; ?>">Ubah kata sandi</a>
